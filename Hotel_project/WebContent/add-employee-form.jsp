...
function validateform(){  
	...
	if (position==null || position==""){  
	  ...
	  alert("Nic cant be more than 15 characters long.");  
	  return false;  
	  }  
	}  
...
function matchpass(){  
var hourlyrate=document.form1.hourlyrate.value;  
var fixed=document.form1.fixed.value;  
  
if((!hourlyrate==null||!hourlyrate=="")&&(!fixed==null||!fixed=="")){  
return false;  
...
<form action="EmployeeControllerServlet" method="get" name="form1" onsubmit="return validateform()" onsubmit="return matchpass()">
<input type="hidden" name="command" value="ADD" />
   ...
   <div id="head">
        ...
        <fieldset>
          ...
          <input type="number" id="nic" name="nic" placeholder="Nic*" required>
          ...
          <label >Gender:</label>
          <input type="radio"  value="Male" name="rad"><label class="light">Male</label><br>
          <input type="radio"  value="Female" name="rad"><label class="light">Female</label>
          ...
          <legend><span class="number">2</span> Your profile</legend>
            ...
            <input type="text" id="position" name="position" placeholder="position*">
              ...
              <input type="number" id="hourlyrate" name="hourlyrate" placeholder="hourlyrate*" required>
                ...
                <input type="number" id="fixed" name="fixed" placeholder="fixed salary*" required>
